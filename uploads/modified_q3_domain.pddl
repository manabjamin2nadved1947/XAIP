...
(:predicates (do_before_new) (generator-ran) (available ?t - tank) (using ?t - tank ?g - generator) (safe ?g - generator) (generatorStarted ?g - generator))
...
(:action generatestart_new
 :parameters (?g - generator)
 :precondition (and (< (running_time) 1) (not (generatorStarted ?g)) (>= (fuelLevel ?g) 0) (safe ?g))
 :effect (and (do_before_new) (generatorStarted ?g) (assign (dur ?g) 0) )
))