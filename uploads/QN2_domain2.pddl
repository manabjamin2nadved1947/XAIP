...
(:functions (fuelLevel ?g - generator) (capacity ?g - generator) (fuelInTank ?t - tank) (ptime ?t - tank) (dur ?g - generator) (runtime))


(:action generateStart
 :parameters (?g - generator)
 :precondition (and (not (generatorStarted ?g)) (>= (fuelLevel ?g) 0) (safe ?g) (> (runtime) 64))
...
(:process clock
 ...
 :effect (and (increase (runtime) (* #t 1)) )	      
)
